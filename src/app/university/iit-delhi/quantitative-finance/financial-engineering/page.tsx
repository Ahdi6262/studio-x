...
import { ArrowLeft, Briefcase, BookOpen, Video, FileText } from "lucide-react";
    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>
            Explore various resources related to Financial Engineering.
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <TabsContent key={category.id} value={category.id}>
                 <div className="p-4 border rounded-md bg-secondary/30 min-h-[200px]">
                  <h3 className="text-lg font-semibold mb-3 text-primary flex items-center">
                    ...
                    {category.title} for Financial Engineering
                  </h3>
                  <div className="flex flex-col items-center justify-center text-center min-h-[150px]">
                      ...
                      <p className="text-muted-foreground max-w-md">
                       Specific {category.title.toLowerCase()} related to financial engineering, such as derivatives pricing, risk management, and portfolio optimization, will be listed here soon.
                      </p>
                  </div>
                </div>
              </TabsContent>
