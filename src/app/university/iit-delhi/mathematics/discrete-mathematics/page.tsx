  ...
  return (
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="bg-card p-8 rounded-lg shadow-lg text-center flex flex-col items-center">
        <Binary className="w-16 h-16 text-primary mb-6" />
        <h2 className="text-3xl font-semibold mb-3">Content Coming Soon!</h2>
        <p className="text-muted-foreground max-w-xl">
          This section will soon feature detailed information on Discrete Mathematics, including combinatorics, graph theory, logic, and set theory.
        </p>
      </div>
    </div>
  );
