...
import { ArrowLeft, Binary, BookOpen, Video, FileText } from "lucide-react";
      ...
      <Card className="shadow-lg">
        <CardHeader>
          <CardTitle className="flex items-center text-2xl">
            <Binary className="mr-3 h-6 w-6 text-primary" />
            Discrete Mathematics Resources
          </CardTitle>
          <CardDescription>
            Explore various resources related to Discrete Mathematics.
          </CardDescription>
        </CardHeader>
        <CardContent>
              ...
              <TabsContent key={category.id} value={category.id}>
                 <div className="p-4 border rounded-md bg-secondary/30 min-h-[200px]">
                  <h3 className="text-lg font-semibold mb-3 text-primary flex items-center">
                    ...
                    {category.title} for Discrete Mathematics
                  </h3>
                  <div className="flex flex-col items-center justify-center text-center min-h-[150px]">
                      ...
                      <p className="text-muted-foreground max-w-md">
                       Specific {category.title.toLowerCase()} related to Discrete Mathematics, including combinatorics, graph theory, logic, and set theory, will be listed here soon.
                      </p>
                  </div>
                </div>
              </TabsContent>
