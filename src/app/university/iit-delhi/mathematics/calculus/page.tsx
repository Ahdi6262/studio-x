    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>
            Explore various resources related to Calculus.
          </CardDescription>
        </CardHeader>
        <CardContent>
                 ...
                 <div className="p-4 border rounded-md bg-secondary/30 min-h-[200px]">
                  ...
                  <div className="flex flex-col items-center justify-center text-center min-h-[150px]">
                      ...
                      <p className="text-muted-foreground max-w-md">
                       Specific {category.title.toLowerCase()} related to Calculus, including single-variable and multi-variable calculus, differential equations, and vector calculus, will be listed here soon.
                      </p>
                  </div>
                </div>
              </TabsContent>
